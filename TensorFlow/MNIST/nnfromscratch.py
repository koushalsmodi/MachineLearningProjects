...
Original file is located at
    https://colab.research.google.com/drive/1ABU97-teVQ19rsYTfOB85mtI20cDaO-f
"""
...
def one_training_step(model, images_batch, labels_batch, batch_size=128):
...
def fit(model, images, labels, epochs = 3, batch_size=128):
